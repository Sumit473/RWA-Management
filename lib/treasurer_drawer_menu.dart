...
class TreasurerDrawerMenu extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  TreasurerDrawerMenu({this.communityName, this.phoneNumber, this.gmailId});
  @override
  _TreasurerDrawerMenuState createState() => _TreasurerDrawerMenuState();
}

class _TreasurerDrawerMenuState extends State<TreasurerDrawerMenu> {
