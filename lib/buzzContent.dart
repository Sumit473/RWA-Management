...
class BuzzContent extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  BuzzContent({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _BuzzContentState createState() => _BuzzContentState();
}

class _BuzzContentState extends State<BuzzContent> {
  String messageText;
