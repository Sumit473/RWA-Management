...
import 'write_queryByComplaintManager.dart';
import 'constants.dart';

class ComplaintManagerQueryToRWA extends StatefulWidget {
  final communityName;
  final phoneNumber;
  final gmailId;

  ComplaintManagerQueryToRWA({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _ComplaintManagerQueryToRWAState createState() => _ComplaintManagerQueryToRWAState();
}

class _ComplaintManagerQueryToRWAState extends State<ComplaintManagerQueryToRWA> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => WriteQueryByComplaintManager(
                              ...
                              showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      ...
                                      content: Text("${queryDescriptions[index]}"),
                                      scrollable: true,
                                    );
                                  });
                            },
