...
class WriteQueryByComplaintManager extends StatefulWidget {
  final communityName;
  final phoneNumber;
  final gmailId;

  WriteQueryByComplaintManager({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _WriteQueryByComplaintManagerState createState() => _WriteQueryByComplaintManagerState();
}

class _WriteQueryByComplaintManagerState extends State<WriteQueryByComplaintManager> {
