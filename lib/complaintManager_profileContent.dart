...
class ComplaintManagerProfileContent extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  ComplaintManagerProfileContent({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _ComplaintManagerProfileContentState createState() => _ComplaintManagerProfileContentState();
}

class _ComplaintManagerProfileContentState extends State<ComplaintManagerProfileContent> {
  String memberName;
  String gender;
  int age;
  File _image;
