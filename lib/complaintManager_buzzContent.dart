...
class ComplaintManagerBuzzContent extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  ComplaintManagerBuzzContent({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _ComplaintManagerBuzzContentState createState() => _ComplaintManagerBuzzContentState();
}

class _ComplaintManagerBuzzContentState extends State<ComplaintManagerBuzzContent> {
  String messageText;
