...
class SecretaryProfileContent extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  SecretaryProfileContent({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _SecretaryProfileContentState createState() => _SecretaryProfileContentState();
}

class _SecretaryProfileContentState extends State<SecretaryProfileContent> {
  String memberName;
  String gender;
  int age;
  File _image;
