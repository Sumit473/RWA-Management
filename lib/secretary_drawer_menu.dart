...
class SecretaryDrawerMenu extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  SecretaryDrawerMenu({this.communityName, this.phoneNumber, this.gmailId});
  @override
  _SecretaryDrawerMenuState createState() => _SecretaryDrawerMenuState();
}

class _SecretaryDrawerMenuState extends State<SecretaryDrawerMenu> {
