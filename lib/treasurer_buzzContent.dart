...
class TreasurerBuzzContent extends StatefulWidget {
  final String communityName;
  final String phoneNumber;
  final String gmailId;

  TreasurerBuzzContent({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _TreasurerBuzzContentState createState() => _TreasurerBuzzContentState();
}

class _TreasurerBuzzContentState extends State<TreasurerBuzzContent> {
  String messageText;
