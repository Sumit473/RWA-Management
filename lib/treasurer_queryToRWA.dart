...
import 'write_queryByTreasurer.dart';
import 'constants.dart';

class TreasurerQueryToRWA extends StatefulWidget {
  final communityName;
  final phoneNumber;
  final gmailId;

  TreasurerQueryToRWA({this.communityName, this.phoneNumber, this.gmailId});

  @override
  _TreasurerQueryToRWAState createState() => _TreasurerQueryToRWAState();
}

class _TreasurerQueryToRWAState extends State<TreasurerQueryToRWA> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => WriteQueryByTreasurer(
